...
export const metadata: Metadata = {
  ...
  keywords: 'travel agency Lucknow, tour packages Lucknow, best travel agent Lucknow, Kashmir tour package, Himachal tour, Ladakh tour, Kedarnath yatra, Char Dham yatra, Goa tour, Kerala tour, Thailand tour, Dubai tour, Maldives honeymoon, international tour packages, domestic tour packages, religious tour packages, honeymoon packages Lucknow, family tour packages, Akash Holidays, cheap tour packages Lucknow, pilgrimage tours Lucknow, Manali tour package, Shimla Manali package, Spiti Valley tour, Rishikesh adventure tour, Mussoorie tour, Nainital tour, Auli ski tour, Munnar package, Alleppey houseboat, Ooty package, Coorg package, Andaman tour, Lakshadweep tour, Meghalaya tour, Sikkim Gangtok package, Darjeeling package, Arunachal Pradesh tour, Udaipur Jaisalmer package, Jaipur tour, Rann of Kutch, Ujjain Mahakal package, Bali tour, Singapore tour, Vietnam tour, Japan tour, Sri Lanka tour, Mauritius tour, Europe tour, Switzerland tour, Azerbaijan Baku tour, Georgia tour, Kazakhstan tour, Uzbekistan tour, Bhutan tour, Nepal tour, Egypt tour',
