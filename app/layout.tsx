...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: 'https://akash-holidays.in/img/Logos.png', width: 1200, height: 630, alt: 'Akash Holidays' }],
    locale: 'en_IN',
    type: 'website',
  },
  twitter: {
  ...
  '@graph': [
    {
      ...
      name: 'Akash Holidays',
      url: 'https://akash-holidays.in',
      logo: 'https://akash-holidays.in/img/Logos.png',
    ...
    },
    {
      ...
      potentialAction: {
        '@type': 'SearchAction',
        target: 'https://akash-holidays.in/packages/{search_term_string}',
